...
class BookRentalsModelTest(TestCase):
    ...
    def setUp(self):
        ...
        self.book_rentals_4 = Book_Rental.objects.create(
                            user=self.user, 
                            book=self.book,
                            date_rented = '2020-08-05 20:08'
                            )
        
        
        self.book_rentals_5 = Book_Rental.objects.create(
                            user=self.user, 
                            book=self.book_3,
                            date_rented = '2020-08-05 20:08'
                            )
    ...
    def test_book_rentals_balance_api_v2(self):
        ...
        request_data = json.loads(request.content)[0]
        self.assertEqual(request.status_code, 200)
        self.assertEqual('31.0', request_data.get('balance'))
